...
const CM001 = new Voyage(new VoyageNumber('CM001'), { carrierMovements: () => [] });
const CM002 = new Voyage(new VoyageNumber('CM002'), { carrierMovements: () => [] });
const CM003 = new Voyage(new VoyageNumber('CM003'), { carrierMovements: () => [] });
const CM004 = new Voyage(new VoyageNumber('CM004'), { carrierMovements: () => [] });
const CM005 = new Voyage(new VoyageNumber('CM005'), { carrierMovements: () => [] });
const CM006 = new Voyage(new VoyageNumber('CM006'), { carrierMovements: () => [] });

// v-series voyages used in the lifecycle scenario test
const v100 = new Voyage.Builder(new VoyageNumber('V100'), HONGKONG)
  .addMovement(TOKYO,   toDate('2009-03-03'), toDate('2009-03-05'))
  .addMovement(NEWYORK, toDate('2009-03-06'), toDate('2009-03-09'))
  .build();

const v200 = new Voyage.Builder(new VoyageNumber('V200'), TOKYO)
...
const v300 = new Voyage.Builder(new VoyageNumber('V300'), TOKYO)
...
const v400 = new Voyage.Builder(new VoyageNumber('V400'), HAMBURG)
...
const HONGKONG_TO_NEW_YORK = new Voyage.Builder(new VoyageNumber('0100S'), HONGKONG)
...
const NEW_YORK_TO_DALLAS = new Voyage.Builder(new VoyageNumber('0200T'), NEWYORK)
...
const DALLAS_TO_HELSINKI = new Voyage.Builder(new VoyageNumber('0300A'), DALLAS)
...
const DALLAS_TO_HELSINKI_ALT = new Voyage.Builder(new VoyageNumber('0301S'), DALLAS)
  .addMovement(HELSINKI, toDate('2008-10-29', '03:30'), toDate('2008-11-05', '15:45'))
  .build();

const HELSINKI_TO_HONGKONG = new Voyage.Builder(new VoyageNumber('0400S'), HELSINKI)
